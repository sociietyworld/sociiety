...
export default function HiighSociietyApplication() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.result === "success") {
        setStatus("Your application has been received.");
        setForm({ name: '', social: '', statement: '' });
      } else {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '2.5rem', color: '#FFD700', textAlign: 'center', marginBottom: '2rem' }}>
          Apply to Hiigh SOCIIETY
        </h1>
        <p style={{ textAlign: 'center', fontSize: '1.1rem', marginBottom: '2rem' }}>
          Please submit your full name, an optional social profile, and a brief statement on why you feel you should be accepted. All applicants undergo a private background review.
        </p>
